...
| **10 (Phase 10C — routing scenarios)** | — | — | TODO (next) | `routing/{deep_link,focus_to_url,unknown_uuid_fallback}.feature` + `persistence/load_save.feature`. The routing wiring already exists (drill / breadcrumb / unknown-uuid fallback are all live in §17.20–§17.32); this commit closes the §15.6 TP-D test plan. |
| **11** | — | — | TODO | Manual kiosk smoke. |
