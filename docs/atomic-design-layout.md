...
| Strand | Scope | Status |
| --- | --- | --- |
| **R0**  | This doc + empty `atoms/ molecules/ organisms/ templates/ pages/` | **in this commit** |
| **R1a** | Atoms — format helpers | pending |
...
| **R3e** | Organisms — WorkflowNode | pending |
| **R3f** | Organisms — PictureNode | pending |
